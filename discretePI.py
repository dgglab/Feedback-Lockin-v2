...
class discretePI:
	...
	def disableOutput(self,idx):
		# disables channel idx
		self.disabledOutputs[idx]=True
		self.outputsDisabled=True
		
	def enableOutput(self,idx):
		# enables channel idx
		self.disabledOutputs[idx]=False
		if np.sum(self.disabledOutputs)>0:
			self.outputsDisabled=False
